...
public class ProducerControllerTest {
  ...
  @Test
  @DisplayName("GET v1/producers/1 throws NotFound 404 when producer is not found")
  @Order(5)
  ...
  @Test
  @DisplayName("DELETE v1/producers/{id} throws NotFound when producer is not found")
  @Order(10)
